...
public class PhoneBook {
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("Home_Work_5/contacts.csv"))) {
            String line;
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("Home_Work_5/new_contacts.csv"))) {
